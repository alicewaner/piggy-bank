// ============================================================
// quiz.js — Quiz engine + 200+ questions, adaptive difficulty
// ============================================================
...
const Quiz = (() => {
  ...
  // 200+ questions across 5 difficulty levels
  const QUESTIONS = {
    1: [ // Easy
      ...
      { q: 'What do cows drink?', a: ['Water', 'Milk', 'Juice', 'Soda'], c: 0 },
      { q: 'How many days are in a week?', a: ['7', '5', '6', '8'], c: 0 },
      { q: 'What season comes after winter?', a: ['Spring', 'Summer', 'Fall', 'Winter'], c: 0 },
      { q: 'If you have 3 apples and eat 1, how many are left?', a: ['2', '3', '1', '4'], c: 0 },
      { q: 'What is 2 + 2?', a: ['4', '3', '5', '2'], c: 0 },
      { q: 'Which is bigger: an elephant or a mouse?', a: ['Elephant', 'Mouse', 'Same', 'Neither'], c: 0 },
      ...
      { q: 'What do you use to write on paper?', a: ['Pencil', 'Fork', 'Hammer', 'Shoe'], c: 0 },
      { q: 'What animal says "moo"?', a: ['Cow', 'Dog', 'Cat', 'Bird'], c: 0 },
      { q: 'What is 8 - 3?', a: ['5', '4', '6', '3'], c: 0 },
      { q: 'How many wheels on a bicycle?', a: ['2', '3', '4', '1'], c: 0 },
      { q: 'What shape is a ball?', a: ['Sphere', 'Cube', 'Cone', 'Flat'], c: 0 },
      { q: 'What is 3 + 4?', a: ['7', '6', '8', '5'], c: 0 },
      { q: 'What is 9 - 1?', a: ['8', '7', '9', '10'], c: 0 },
      { q: 'What month comes after January?', a: ['February', 'March', 'December', 'April'], c: 0 },
      ...
      { q: 'What do fish live in?', a: ['Water', 'Air', 'Sand', 'Mud'], c: 0 },
      { q: 'What is 4 - 4?', a: ['0', '1', '4', '2'], c: 0 },
      { q: 'What color is a banana?', a: ['Yellow', 'Red', 'Blue', 'Green'], c: 0 },
      { q: 'What is 5 + 5?', a: ['10', '9', '11', '8'], c: 0 },
      { q: 'Which is a fruit: apple or chair?', a: ['Apple', 'Chair', 'Both', 'Neither'], c: 0 },
    ...
    2: [ // Medium-Easy
      ...
      { q: 'What planet do we live on?', a: ['Earth', 'Mars', 'Venus', 'Jupiter'], c: 0 },
      ...
      { q: 'What shape has 4 equal sides?', a: ['Square', 'Rectangle', 'Triangle', 'Pentagon'], c: 0 },
      { q: 'What is 5 x 5?', a: ['25', '20', '30', '15'], c: 0 },
      { q: 'Which coin is worth the most: dime, nickel, or penny?', a: ['Dime', 'Nickel', 'Penny', 'All same'], c: 0 },
      { q: 'What is 14 + 19?', a: ['33', '32', '34', '31'], c: 0 },
      { q: 'How many cups in a quart?', a: ['4', '2', '8', '3'], c: 0 },
      { q: 'What is 45 - 18?', a: ['27', '23', '33', '25'], c: 0 },
      { q: 'What is 6 x 6?', a: ['36', '30', '42', '24'], c: 0 },
      { q: 'If a toy costs $4.25 and tax is $0.25, what is the total?', a: ['$4.50', '$4.00', '$4.75', '$5.00'], c: 0 },
      { q: 'What is 72 / 8?', a: ['9', '8', '7', '10'], c: 0 },
      { q: 'How many continents are there?', a: ['7', '5', '6', '8'], c: 0 },
      { q: 'What is 3 x 9?', a: ['27', '24', '30', '21'], c: 0 },
      { q: 'What is half of 20?', a: ['10', '5', '15', '8'], c: 0 },
    ],
    3: [ // Medium
      ...
      { q: 'How many feet in a mile?', a: ['5,280', '5,000', '1,000', '10,000'], c: 0 },
      ...
      { q: 'How many ounces in a pound?', a: ['16', '12', '8', '32'], c: 0 },
      ...
      { q: 'What is the boiling point of water in Fahrenheit?', a: ['212', '100', '200', '180'], c: 0 },
      ...
      { q: 'How many states are in the USA?', a: ['50', '48', '52', '51'], c: 0 },
      ...
      { q: 'How many seconds in a minute?', a: ['60', '100', '30', '90'], c: 0 },
      ...
      { q: 'How many zeros in one thousand?', a: ['3', '4', '2', '5'], c: 0 },
      { q: 'What is double 45?', a: ['90', '80', '100', '85'], c: 0 },
      { q: 'What is 99 + 99?', a: ['198', '188', '208', '196'], c: 0 },
      { q: 'If a pizza is cut into 8 slices and you eat 3, what fraction is left?', a: ['5/8', '3/8', '3/5', '5/3'], c: 0 },
      { q: 'What is 15 x 4?', a: ['60', '55', '65', '45'], c: 0 },
      { q: 'What is 200 - 87?', a: ['113', '123', '103', '117'], c: 0 },
      { q: 'How many hours in a day?', a: ['24', '12', '48', '36'], c: 0 },
      { q: 'What is the value of 5 dimes and 3 nickels?', a: ['65 cents', '80 cents', '55 cents', '35 cents'], c: 0 },
    ...
    4: [ // Medium-Hard
      ...
      { q: 'If 5 workers do a job in 6 days, how many worker-days?', a: ['30', '11', '25', '35'], c: 0 },
      ...
      { q: 'How many millimeters in a meter?', a: ['1,000', '100', '10,000', '10'], c: 0 },
      ...
      { q: 'If a recipe needs 2/3 cup and you triple it, how much?', a: ['2 cups', '6/3 cups', '1 cup', '3 cups'], c: 0 },
      { q: 'What is the area of a triangle with base 10 and height 6?', a: ['30', '60', '16', '20'], c: 0 },
      { q: 'How many degrees in a right angle?', a: ['90', '180', '45', '360'], c: 0 },
      ...
      { q: 'If it rains 3 inches every 2 days, how much in 10 days?', a: ['15 in', '30 in', '6 in', '10 in'], c: 0 },
      { q: 'What is 14 x 14?', a: ['196', '186', '204', '169'], c: 0 },
      { q: 'How many faces does a rectangular prism have?', a: ['6', '4', '8', '12'], c: 0 },
      { q: 'What is 60% of 500?', a: ['300', '350', '250', '200'], c: 0 },
      { q: 'If gas costs $3.50/gallon and you buy 10 gallons?', a: ['$35', '$30', '$40', '$25'], c: 0 },
      { q: 'What is 7 x 13?', a: ['91', '84', '98', '77'], c: 0 },
      { q: 'What is 10,000 - 3,578?', a: ['6,422', '6,432', '7,422', '6,522'], c: 0 },
    ],
    5: [ // Hard
      ...
      { q: 'If a car depreciates 20% per year and costs $10,000, what is it worth after 1 year?', a: ['$8,000', '$2,000', '$9,000', '$7,000'], c: 0 },
      ...
      { q: 'What is 7 factorial (7!)?', a: ['5,040', '720', '2,520', '40,320'], c: 0 },
      { q: 'If you earn $12/hour with 1.5x overtime after 40 hours, what for 45 hours?', a: ['$570', '$540', '$480', '$600'], c: 0 },
      { q: 'What is the area of a circle with radius 7? (use 22/7)', a: ['154', '44', '49', '308'], c: 0 },
      ...
      { q: 'How many faces on an icosahedron?', a: ['20', '12', '8', '6'], c: 0 },
      ...
      { q: 'The sum of angles in a triangle is?', a: ['180', '360', '90', '270'], c: 0 },
      { q: 'What is 3 to the power of 5?', a: ['243', '125', '81', '729'], c: 0 },
      { q: 'If a recipe is for 4 people and you need it for 10, multiply by?', a: ['2.5', '2', '3', '6'], c: 0 },
      { q: 'What is 1,111 x 5?', a: ['5,555', '5,505', '5,550', '5,565'], c: 0 },
      { q: 'How many degrees in a full circle?', a: ['360', '180', '90', '270'], c: 0 },
      { q: 'If compound interest is 10% on $100 for 2 years, the total is?', a: ['$121', '$120', '$110', '$130'], c: 0 },
      { q: 'What is the Pythagorean theorem for a 3-4-5 triangle hypotenuse?', a: ['5', '7', '12', '6'], c: 0 },
      ...
      { q: 'If you spend 1/4 of $80 on food and 1/3 on rent, how much is left?', a: ['$33.33', '$40.00', '$46.67', '$26.67'], c: 0 },
      { q: 'What is 256 / 16?', a: ['16', '12', '18', '24'], c: 0 },
      { q: 'How many permutations of 3 items from 5? (5P3)', a: ['60', '10', '120', '15'], c: 0 },
      ...
      { q: 'If sales double every year from $100, what after 3 years?', a: ['$800', '$400', '$600', '$300'], c: 0 },
      { q: 'What is 47 x 53?', a: ['2,491', '2,481', '2,501', '2,391'], c: 0 },
    ]
  };

  function pickQuestions(difficulty) {
    const pool = QUESTIONS[difficulty] || QUESTIONS[1];
  ...
  function start() {
    ...
    currentQuestions = pickQuestions(state.quizDifficulty);
    currentIndex = 0;
    score = 0;
    streak = 0;
    showQuestion();
  ...
  function showQuestion() {
    ...
    // Shuffle answers (keeping track of correct)
